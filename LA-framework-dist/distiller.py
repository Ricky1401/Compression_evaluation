...
class Distiller:
    ...
    def process_data_dolly(self):
        ...
        checkpoint_path = self.teacher_model.checkpoint_path
        print(f"Processing data for {teacher_name}")
        os.system(f"bash minillm/scripts/generic/tools/process_data_dolly.sh minillm {teacher_name} ../{checkpoint_path}")
