...
class PPOTrainer():
    ...
    def __init__(self, args, tokenizer: AutoTokenizer, reward_fn: callable, ds_config):
        ...
        self.model = PPOModel(args, self.device, tokenizer)
        if args.model_parallel:
        ...
        #print(self.model)       
        self.model.base_model.config.pad_token_id = tokenizer.pad_token_id
        self.model.base_model.config.eos_token_id = tokenizer.eos_token_id
        ...
        self.generate_kwargs = dict(
            ...
            bos_token_id=151669       ################### model specific parameter
        )
