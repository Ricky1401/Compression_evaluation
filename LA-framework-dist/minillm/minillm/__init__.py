...
def train(
    ...
    print(teacher_model)
    print("Teacher vocab_size:", teacher_model.config.vocab_size)
    args.peft = None
    trainer = PPOTrainer(
        args=args,
        tokenizer=tokenizer,
    ...
    #trainer.model.module.base_model.config.pad_token_id = tokenizer.pad_token_id
    #trainer.model.module.base_model.config.eos_token_id = tokenizer.eos_token_id
    #trainer.model.module.base_model.resize_token_embeddings(len(tokenizer))
    #print(trainer.model)
